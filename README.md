...
<img width="941" height="376" alt="Диаграмма без названия-Страница-2 (1)" src="https://github.com/user-attachments/assets/8a017033-53b6-4fbc-851e-e9ad8e387e81" />
...
## Пример работы поиска времени на основе автомата для поиска подстрок

Программа должна находить только записанное время в формате HH:MM:SS.

### Входная строка
Добрый день! Сейчас 10:30:54

Расскажите, в 12:00:00 или в 13:00 назначена встреча?

Мне нужно сверить расписание. Как у нас с созвоном в 14 часов? конкретно в 14:10. Ещё конкретнее в 14:10:00

Программа должна найти 3 подстроки, которые удовлетворяют формату.

<img width="1870" height="1256" alt="image" src="https://github.com/user-attachments/assets/54eeb5e6-5652-4971-ab0d-5fc8c24a14c0" />

Программа отметила 10:30:54, 12:00:00, 14:10:00 и не отметила другие подстроки со временем, например, 13:00 или 14:10, 14.
