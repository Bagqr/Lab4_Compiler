...
- [^#] - любой символ кроме решётки
- """ - тройные двойные кавычки, вариант многострочных комментариев
- [/*] - любой символ (итерационно)
- ''' - тройные кавычки, вариант многострочных комментариев
...
<img width="771" height="454" alt="Диаграмма без названия-Страница-4" src="https://github.com/user-attachments/assets/cf0dd733-e3e3-4288-a8df-44cb50bdfac7" />

## Описание состояний:
- Start - начальное состояние
- Hash - комментарий с решёткой
- DoubleQuote1/DoubleQuote2 - первые и вторые двойные кавычки в комментариях
- InDoubleQuote - содержимое комментариев в двойных кавычках
- DoubleClose1/DoubleClose2 - первые и вторые закрывающие двойные кавычки
- DoubleEnd - конец комментария с двойными кавычками
- SingleQuote1/SingleQuote2 - первые и вторые одинарные кавычки
- InSingleQuote - содержимое комментария в одинарных кавычках
- SingleClose1/SingleClose2 - первые и вторые завершающие одинарные кавычки
- SingleEnd - конец комментария с одинарными кавычками
  
## Пример работы поиска времени на основе автомата для поиска подстрок
Строка:
#однострочный комментарий бебебе
...
<img width="1865" height="1252" alt="image" src="https://github.com/user-attachments/assets/9bbeb80d-7a19-4596-a8d9-42293e49200a" />
